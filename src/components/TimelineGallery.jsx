...
const TimelineGallery = ({ onPictureClick, selectedPicture, isModalOpen, onCloseModal }) => {
  ...
  const imageData = [
    ...
    {
      id: '3',
      src: '/Bubbaloooo/images/65A51AA3-D1D0-4AEA-B0B8-180B2AB7D887.PNG', 
      alt: 'Memory Image 3',
    ...
    {
      id: '4',
      src: '/Bubbaloooo/images/66DA4B2E-D3F0-4753-B2E1-817104651353.PNG',
      alt: 'Memory Image 4', 
    ...
    {
      id: '5',
      src: '/Bubbaloooo/images/77F9DB42-46BA-4C30-8BF9-C55FABA0369B.PNG',
      alt: 'Memory Image 5',
    ...
    {
      id: '6',
      src: '/Bubbaloooo/images/96471055-DE4D-4DF7-AD49-CD7A8372F9F4.PNG',
      alt: 'Memory Image 6',
    ...
    {
      id: '7',
      src: '/Bubbaloooo/images/9ABE5A13-4EF6-4C0A-833A-8D5D9491DF06.PNG',
      alt: 'Memory Image 7',
